...
const routes: Routes = [
  ...
  { path: 'mentorlist', component: MentorlistComponent , canActivate: [AuthGuard],data: { expectedRole: ['admin','mentor'] } },
  ...
  {path : 'internmentorlist',component:InternmentorlistComponent},
  {path : 'adminregister',component:AdminregisterComponent, canActivate: [AuthGuard], data: { expectedRole: 'admin' }}
];
